...
features:
  ...
  - title: ホーム画面ウィジェット
    body: 今日のタスクとカレンダーの予定を1つのウィジェットにまとめて表示。ワンタップで最新に更新でき、アプリを開かなくても今日やることが一目でわかります。
  - title: Google ドライブにバックアップ & 復元
    body: 自分の Google ドライブに、タスクや習慣をまるごとバックアップ。機種変更や別の端末でも、ログインして復元するだけ。面倒な URL やキーの設定は要りません。
---

「やることが多いのに、なかなか手につかない」── そんなとき、頭の中をぜんぶ書き出して、次の一手だけに集中できるように、と作った GTD（Getting Things Done）ベースのタスクメモです。

まず Inbox に放り込んで、あとから「メモ・次のアクション・予定・いつか」に仕分けるだけ。習慣トラッカーと週次レビューで、続ける・振り返るところまでをやさしく支えます。
